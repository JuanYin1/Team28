...
| **Average Response Quality** | 0.828/1.000 | Multi-criteria evaluation score |
| **Average Execution Time** | 24.6 seconds | Time efficiency |
...
| **Reasoning Quality** | 0.545/1.000 | Moderate step-by-step thinking |
...
- **Complex**: 0.822 average score (2 tests)
