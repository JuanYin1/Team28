...
| **Average Response Quality** | 0.840/1.000 | Multi-criteria evaluation score |
| **Average Execution Time** | 29.9 seconds | Time efficiency |
...
| **Reasoning Quality** | 0.575/1.000 | Moderate step-by-step thinking |
...
| logic_puzzle | medium | ✅ | ✅ | 0.810 | 1.000 | ✅ PASS |
| file_operations | medium | ✅ | ✅ | 0.940 | 0.800 | ✅ PASS |
| code_debugging | complex | ✅ | ✅ | 0.795 | 0.900 | ✅ PASS |
...
- **Complex**: 0.785 average score (2 tests)
...
• Completeness: 1.00 (weight: 0.2)
• Reasoning Quality: 0.53 (weight: 0.4)
• Efficiency: 1.00 (weight: 0.0)
...
**Key Insights**: Overall Score: 0.94 (PASS)
...
**Key Insights**: Overall Score: 0.79 (PASS)
