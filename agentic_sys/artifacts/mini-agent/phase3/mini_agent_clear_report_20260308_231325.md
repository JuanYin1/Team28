...
### ⚡ Latency Dimension  
- **Task completion speed**: 4.5 seconds average
...
|-----------|----------|---------|---------|----------|------|------|-------|------------|-------------|--------|
| simple_file_operations | file_operations | 0.450 | 1.000 | 1.00 | $0.001 | 1.5s | 0 | COMPARABLE | no | ❌ FAIL |
| python_coding_task | coding | 0.450 | 1.000 | 1.00 | $0.001 | 1.9s | 0 | COMPARABLE | no | ❌ FAIL |
| data_analysis_task | analysis | 0.450 | 1.000 | 1.00 | $0.002 | 2.2s | 0 | COMPARABLE | no | ❌ FAIL |
| error_handling_test | reasoning | 0.450 | 1.000 | 1.00 | $0.002 | 12.3s | 0 | COMPARABLE | no | ❌ FAIL |
...
|-----------|---------|-------|----------|--------|-----------|---------|-----------|
| simple_file_operations | 0.00 | 0.0% | 0.00 | 0.0% | 1.50 | 99.9% | 1.50 |
| python_coding_task | 0.00 | 0.0% | 0.00 | 0.0% | 1.89 | 100.0% | 1.89 |
| data_analysis_task | 0.00 | 0.0% | 0.00 | 0.0% | 2.20 | 100.1% | 2.20 |
| error_handling_test | 0.00 | 0.0% | 0.00 | 0.0% | 12.32 | 100.0% | 12.32 |
...
|---|------------|-----------------|-------|-------------|
| 1 | error | 1.83 | 2.3 | 83.7 |

### python_coding_task (coding)

| # | Event Type | Time Offset (s) | CPU % | Memory (MB) |
|---|------------|-----------------|-------|-------------|
| 1 | error | 1.41 | 2.3 | 73.1 |

### data_analysis_task (analysis)

| # | Event Type | Time Offset (s) | CPU % | Memory (MB) |
|---|------------|-----------------|-------|-------------|
| 1 | error | 2.26 | 2.3 | 85.4 |

### error_handling_test (reasoning)

| # | Event Type | Time Offset (s) | CPU % | Memory (MB) |
|---|------------|-----------------|-------|-------------|
| 1 | error | 16.24 | 1.7 | 86.0 |
