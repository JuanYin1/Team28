...
| **Average Response Quality** | 0.744/1.000 | Multi-criteria evaluation score |
| **Average Execution Time** | 8.1 seconds | Time efficiency |
...
| **Reasoning Quality** | 0.560/1.000 | Moderate step-by-step thinking |
| **Task Completeness** | 0.677/1.000 | Partial task coverage |
...
|-----------|------------|-----------|------------|---------------|------------|--------|
| arithmetic_reasoning | simple | ✅ | ✅ | 0.838 | 0.800 | ✅ PASS |
| logic_puzzle | medium | ✅ | ✅ | 0.796 | 0.900 | ✅ PASS |
| file_operations | medium | ✅ | ✅ | 0.886 | 0.800 | ✅ PASS |
| code_debugging | complex | ✅ | ❌ | 0.684 | 0.900 | ❌ FAIL |
| system_analysis | complex | ✅ | ❌ | 0.515 | 0.900 | ❌ FAIL |
...
- **Simple**: 0.838 average score (1 tests)
- **Medium**: 0.841 average score (2 tests)
- **Complex**: 0.599 average score (2 tests)
...
**Key Insights**: Overall Score: 0.84 (PASS)

Component Breakdown:
• Correctness: 1.00 (weight: 0.5)
• Completeness: 0.60 (weight: 0.2)
• Reasoning Quality: 0.73 (weight: 0.3)
...
• Reasoning Quality: 0.65 (weight: 0.2)
• Efficiency: 1.00 (weight: 0.0)
...
**Key Insights**: Overall Score: 0.52 (FAIL)
