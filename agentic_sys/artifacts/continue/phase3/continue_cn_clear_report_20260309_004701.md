...
| python_coding_task | coding | 0.200 | 0.000 | 1.00 | $0.001 | 1.6s | 0 | COMPARABLE | SOFT_NON_COMPARABLE | no | ❌ FAIL |
| data_analysis_task | analysis | 0.200 | 0.000 | 1.00 | $0.001 | 1.9s | 0 | COMPARABLE | SOFT_NON_COMPARABLE | no | ❌ FAIL |
...
|-----------|---------|-------|----------|--------|-----------|---------|-----------|
| simple_file_operations | 0.00 | 0.0% | 0.00 | 0.0% | 1.80 | 99.9% | 1.81 |
| python_coding_task | 0.00 | 0.0% | 0.00 | 0.0% | 1.62 | 99.8% | 1.63 |
| data_analysis_task | 0.00 | 0.0% | 0.00 | 0.0% | 1.92 | 99.9% | 1.92 |
| error_handling_test | 0.00 | 0.0% | 0.00 | 0.0% | 1.67 | 100.2% | 1.67 |
...
|---|------------|-----------------|-------|-------------|
| 1 | error | 0.00 | 0.0 | 0.2 |
| 2 | error | 1.88 | 1.9 | 273.2 |

### python_coding_task (coding)

| # | Event Type | Time Offset (s) | CPU % | Memory (MB) |
|---|------------|-----------------|-------|-------------|
| 1 | error | 0.00 | 2.5 | 2.2 |
| 2 | error | 1.62 | 1.7 | 283.8 |
...
| 2 | error | 2.40 | 2.5 | 256.8 |

### error_handling_test (reasoning)

| # | Event Type | Time Offset (s) | CPU % | Memory (MB) |
|---|------------|-----------------|-------|-------------|
| 1 | error | 0.00 | 0.8 | 0.8 |
| 2 | error | 1.65 | 1.9 | 298.1 |
